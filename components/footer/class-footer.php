				...
				'options' => array(
					'footer_options_customizer_tabs'    => array(
						...
						'html' => '<nav class="section-navigation  js-section-navigation">
							<a href="#section-title-footer-layout">' . esc_html__( 'Layout', 'noah' ) . '</a>
							<a href="#section-title-footer-colors">' . esc_html__( 'Colors', 'noah' ) . '</a>
							</nav>',
					),
					// [Section] Layout
					'footer_title_layout_section'    => array(
						'type' => 'html',
						'html' => '<span id="section-title-footer-layout" class="separator section label large">&#x1f4d0; ' . esc_html__( 'Layout', 'noah' ) . '</span>',
					),
					...
					'footer_top_spacing'           => array(
						'type'        => 'range',
						'label'       => esc_html__( 'Top Spacing', 'noah' ),
						'desc'        => '',
						'live'        => true,
						'default'     => 0,
						'input_attrs' => array(
					...
					'footer_bottom_spacing'        => array(
						'type'        => 'range',
						'label'       => esc_html__( 'Bottom Spacing', 'noah' ),
						'desc'        => '',
						'live'        => true,
						'default'     => 90,
						'input_attrs' => array(
					...
					'footer_hide_back_to_top_link' => array(
						'type'    => 'checkbox',
						'label'   => esc_html__( 'Hide "Back To Top" Link', 'noah' ),
						'default' => 1,
					),
					'footer_layout'                => array(
						'type'    => 'select',
						'label'   => esc_html__( '"Footer Area" Widgets Layout', 'noah' ),
						'desc'    => esc_html__( 'Choose if you want the footer widgets stack into one column or spread to a row.', 'noah' ),
						'default' => 'row',
						'choices' => array(
					...
					'footer_title_colors_section'    => array(
						'type' => 'html',
						'html' => '<span id="section-title-footer-colors" class="separator section label large">&#x1f3a8; ' . esc_html__( 'Colors', 'noah' ) . '</span>',
					),
					...
					'footer_links_color'           => array(
						'type'    => 'color',
						'label'   => esc_html__( 'Links Color', 'noah' ),
						'live'    => true,
						'default' => '#000000',
						'css'     => array(
							array(
					...
					'footer_background'            => array(
						'type'    => 'color',
						'label'   => esc_html__( 'Footer Background', 'noah' ),
						'live'    => true,
						'default' => '#FFFFFF',
						'css'     => array(
							array(
